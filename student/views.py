...
def password_reset(request):
    ...
    if request.method == "POST":
        ...
        if stage == "email":
            ...
            try:
                ...
                return render(request, "student/password_reset.html", {"stage": "otp"})
            ...
            if entered_otp == session_otp:
                ...
                return render(request, "student/password_reset.html", {"stage": "new_password"})
            else:
    ...
    return render(request, "student/password_reset.html", {"stage": "email"})
